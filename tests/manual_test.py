...
# def test_neg_backward():  # noqa: ANN201
...
#     def reverse_permutation(perm):  # noqa: ANN001, ANN202
#         n = len(perm)
#         reversed_perm = [0] * n
#         for i in range(n):
